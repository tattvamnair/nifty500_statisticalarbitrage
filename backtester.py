...
TIMEFRAME = '5M' 
FORMATION_PERIOD_DAYS = 252  # Approx. 2 trading months
PAIR_RECALC_PERIOD_DAYS = 15  # Recalculate every ~3 weeks
...
#TIMEFRAME = '1H' 
#FORMATION_PERIOD_DAYS = 126 # Approx. 6 trading months
#PAIR_RECALC_PERIOD_DAYS = 42  # Recalculate every ~2 months

#TIMEFRAME = '4H' 
#FORMATION_PERIOD_DAYS = 252 # 1 full trading year
#PAIR_RECALC_PERIOD_DAYS = 63  # Recalculate quarterly
...
TRADE_NOTIONAL_PER_PAIR = 250_000.0
FIXED_THEORETICAL_NOTIONAL = 100_000.0

TRANSACTION_COST_BPS = 5
ANNUAL_BORROW_COST_PERCENT = 2
